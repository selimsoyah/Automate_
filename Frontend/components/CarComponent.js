        ...
        <View style={styles.Group395}>
          ...
          <View style={styles.Group7410}>
            <View style={styles.Group034}>
              ...
              <View style={styles.Group418}>
                <Image
                  style={styles.Gearbox}
                  source={{
                    uri: "https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/t4oe6q8rlr8-1146%3A75?alt=media&token=85028365-55e5-4015-9268-0bafb9b9e315",
                  }}
                />
                <Text style={styles.AT}>A/T</Text>
              </View>
            </View>
            <Image
              style={styles.UserAccount}
              source={{
                uri: "https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/t4oe6q8rlr8-1146%3A74?alt=media&token=f9569dc3-4b1b-4629-95fc-c50b5a89f610",
              }}
            />
            <Text style={styles._5}>5</Text>
            <Image
              style={styles.CarDoor}
              source={{
                uri: "https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/t4oe6q8rlr8-1146%3A72?alt=media&token=4bd7f3f4-8899-4a30-8c58-1a4bc4fc13a4",
              }}
            />
            ...
            <Image
              style={styles.Sun}
              source={{
                uri: "https://firebasestorage.googleapis.com/v0/b/unify-v3-copy.appspot.com/o/t4oe6q8rlr8-1146%3A73?alt=media&token=c8c2928d-9be7-4042-9e04-01a4c2e597af",
              }}
            />
